...
history_dense = np.load("history_Hopper_Action_Dense.npy", allow_pickle=True).item()
history_lstm = np.load("history_Hopper_Action_LSTM.npy", allow_pickle=True).item()
